...
class MainView(QMainWindow):
    def __init__(self, model, main_controller):
        ...
        self._ui.large_bottle_button.clicked.connect(lambda: self._main_controller.add_glass(200))
    ...
    # def add_glass(self):
    #     self._model._current_water += 200
    #     self._ui.water_bar.setProperty('value', self._model._current_water / 10) ##
    #     self._ui.water_number.setProperty('intValue', (self._model._current_water / 100))
    #     print(self._model._current_water)
    #     return self._model._current_water
            # water_adder(self)
